        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center">
            <h1 className="text-2xl font-bold text-gray-900 truncate">
              {asset.params?.name || `Asset ${asset.index ?? asset.tokenId}`}
            </h1>
          ...
          <div className="mt-1 flex flex-col sm:flex-row sm:flex-wrap sm:space-x-6">
            <div className="mt-2 flex items-center text-sm text-gray-500">
              ...
              <span className="ml-1 font-mono">{asset.index ?? asset.tokenId}</span>
              <button
                onClick={() => copyToClipboard(String(asset.index ?? asset.tokenId))}
            ...
            <div className="mt-2 flex items-center text-sm text-gray-500">
              ...
              <span className="ml-1">{formatNumber(asset.params?.total ?? 0)}</span>
            </div>
          </div>
        </div>
